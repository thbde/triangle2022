...
import triangle.implementations.tbach.TriangleFirstTry;

import static org.assertj.core.api.Assertions.assertThat;

public class TriangleNeufingTest {

	public static final Triangle triangle = new TriangleNeufing();
	...
	@Test
	public void testGetTriangleResultForNullLength() {
	...
	@Test
	public void testGetTriangleResultForLengthsWith2Length() {
		final int[] input = { 42, 42 };
		final TriangleResult expected = TriangleResult.UNKNOWN;
		final TriangleResult result = triangle.getTriangleResultForLengths(input);
		assertThat(result).isEqualTo(expected);
	}
	...
	@Test
	public void testGetTriangleResultForLengthsWith4Length() {
		final int[] input = { 42, 42, 42, 42 };
		final TriangleResult expected = TriangleResult.UNKNOWN;
		final TriangleResult result = triangle.getTriangleResultForLengths(input);
		assertThat(result).isEqualTo(expected);
	}
	...
	@Test
	public void testGetTriangleResultForLengthsWithNegativeValue() {
		final int[] input = { 42, 42, -42};
		final TriangleResult expected = TriangleResult.UNKNOWN;
		final TriangleResult result = triangle.getTriangleResultForLengths(input);
		assertThat(result).isEqualTo(expected);
